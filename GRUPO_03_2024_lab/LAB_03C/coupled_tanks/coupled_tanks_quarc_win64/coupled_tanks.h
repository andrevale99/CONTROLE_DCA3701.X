...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } NivelTank2_PWORK;                  /* '<Root>/Nivel Tank 2' */

  struct {
    void *LoggedData;
  } TensaoBomba_PWORK;                 /* '<Root>/Tensao Bomba' */
...
struct P_coupled_tanks_T_ {
  ...
  real_T N_Gain;                       /* Expression: 1
                                        ...
                                        */
  real_T ki_Gain;                      /* Expression: 0.021
 ...
 * '<S2>'   : 'coupled_tanks/Subsystem'
 * '<S3>'   : 'coupled_tanks/Subsystem/Compare To Constant'
 * '<S4>'   : 'coupled_tanks/Subsystem/Compare To Constant1'
 * '<S5>'   : 'coupled_tanks/Subsystem/Compare To Constant2'
 * '<S6>'   : 'coupled_tanks/Subsystem/Compare To Constant3'
 * '<S7>'   : 'coupled_tanks/Subsystem/Compare To Zero'
 * '<S8>'   : 'coupled_tanks/Subsystem/Compare To Zero1'
 */
