...
typedef struct {
  real_T VoltstocmTank1;               /* '<S2>/Volts to cm Tank 1 ' */
  real_T VoltstocmTank2;               /* '<S2>/Volts to cm Tank 2' */
  real_T Integrator_e;                 /* '<Root>/Integrator_e' */
  real_T Integrator_m;                 /* '<Root>/Integrator_m' */
  real_T SetPoint;                     /* '<Root>/Constant' */
  real_T Sum;                          /* '<Root>/Sum' */
  real_T Kp_m;                         /* '<Root>/Kp_m' */
  real_T N_mfiltergain;                /* '<Root>/N_m (filter gain)' */
  real_T kd_m;                         /* '<Root>/kd_m ' */
  real_T Add;                          /* '<Root>/Add' */
  real_T Kp_e;                         /* '<Root>/Kp_e' */
  real_T N_mfiltergain1;               /* '<Root>/N_m (filter gain)1' */
  real_T kd_e;                         /* '<Root>/kd_e' */
  real_T NaoSaturado;                  /* '<Root>/Add1' */
  real_T MultiportSwitch;              /* '<S1>/Multiport Switch' */
  real_T Ki_m;                         /* '<Root>/Ki_m  ' */
  real_T Sum3;                         /* '<Root>/Sum3' */
  boolean_T Compare;                   /* '<S7>/Compare' */
  boolean_T Compare_f;                 /* '<S6>/Compare' */
} B_coupled_tanks_T;
...
typedef struct {
  ...
  real_T TimeStampA;                   /* '<Root>/Derivative_m' */
  real_T LastUAtTimeA;                 /* '<Root>/Derivative_m' */
  real_T TimeStampB;                   /* '<Root>/Derivative_m' */
  real_T LastUAtTimeB;                 /* '<Root>/Derivative_m' */
  real_T TimeStampA_g;                 /* '<Root>/Derivative_e' */
  real_T LastUAtTimeA_p;               /* '<Root>/Derivative_e' */
  real_T TimeStampB_o;                 /* '<Root>/Derivative_e' */
  real_T LastUAtTimeB_f;               /* '<Root>/Derivative_e' */
  ...
  struct {
    void *LoggedData;
  } AesdeControle_PWORK;               /* '<Root>/Ações de Controle' */

  struct {
    void *LoggedData;
  } AesdeControleMalhaEscrava_PWORK;   /* '<Root>/Ações de Controle Malha Escrava' */

  struct {
    void *LoggedData;
  } AesdeControleMalhaMestre_PWORK;    /* '<Root>/Ações de Controle Malha Mestre' */
...
typedef struct {
  real_T Integrator_e_CSTATE;          /* '<Root>/Integrator_e' */
  real_T Integrator_m_CSTATE;          /* '<Root>/Integrator_m' */
  real_T Integrator_gain_CSTATE;       /* '<Root>/Integrator_gain' */
  real_T Integrator_gain2_CSTATE;      /* '<Root>/Integrator_gain2' */
} X_coupled_tanks_T;
...
typedef struct {
  ...
  real_T Integrator_gain_CSTATE;       /* '<Root>/Integrator_gain' */
  real_T Integrator_gain2_CSTATE;      /* '<Root>/Integrator_gain2' */
} XDot_coupled_tanks_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator_e_CSTATE;       /* '<Root>/Integrator_e' */
  boolean_T Integrator_m_CSTATE;       /* '<Root>/Integrator_m' */
  boolean_T Integrator_gain_CSTATE;    /* '<Root>/Integrator_gain' */
  boolean_T Integrator_gain2_CSTATE;   /* '<Root>/Integrator_gain2' */
} XDis_coupled_tanks_T;
...
#define rtX                            coupled_tanks_X
#define ContinuousStates               X_coupled_tanks_T
#define rtXdot                         coupled_tanks_XDot
#define StateDerivatives               XDot_coupled_tanks_T
#define tXdis                          coupled_tanks_XDis
#define StateDisabled                  XDis_coupled_tanks_T
...
struct P_coupled_tanks_T_ {
  ...
  real_T Integrator_e_IC;              /* Expression: 0
                                        ...
                                        */
  real_T Integrator_m_IC;              /* Expression: 0
                                        * Referenced by: '<Root>/Integrator_m'
                                        */
  real_T Constant_Value_o;             /* Expression: 5
                                        * Referenced by: '<Root>/Constant'
                                        */
  real_T Kp_m_Gain;                    /* Expression: 1.2
                                        * Referenced by: '<Root>/Kp_m'
                                        */
  real_T Integrator_gain_IC;           /* Expression: 0
                                        * Referenced by: '<Root>/Integrator_gain'
                                        */
  real_T N_mfiltergain_Gain;           /* Expression: 0.1
                                        * Referenced by: '<Root>/N_m (filter gain)'
                                        */
  real_T kd_m_Gain;                    /* Expression: 0.4
                                        * Referenced by: '<Root>/kd_m '
                                        */
  real_T Kp_e_Gain;                    /* Expression: 1
                                        * Referenced by: '<Root>/Kp_e'
                                        */
  real_T Integrator_gain2_IC;          /* Expression: 0
                                        * Referenced by: '<Root>/Integrator_gain2'
                                        */
  real_T N_mfiltergain1_Gain;          /* Expression: 0.8
                                        * Referenced by: '<Root>/N_m (filter gain)1'
                                        */
  real_T kd_e_Gain;                    /* Expression: 0.8
                                        * Referenced by: '<Root>/kd_e'
                                        */
  real_T Constant_Value_k;             /* Expression: 0
                                        * Referenced by: '<S8>/Constant'
                                        */
  real_T OpNormal_Value;               /* Expression: 3
                                        * Referenced by: '<S1>/Op Normal'
                                        */
  real_T MantemAbombaem30cm_Value;     /* Expression: 1.5
                                        * Referenced by: '<S1>/Mantem A bomba em 30cm'
                                        */
  real_T Desligaabomba_Value;          /* Expression: 0
                                        * Referenced by: '<S1>/Desliga a bomba'
                                        */
  real_T KawKptaw_Gain;                /* Expression: 0
                                        * Referenced by: '<Root>/Kaw = Kp // taw'
                                        */
  real_T Ki_e_Gain;                    /* Expression: 0
                                        * Referenced by: '<Root>/Ki_e'
                                        */
  real_T Ki_m_Gain;                    /* Expression: 0.2
...
/* Continuous states (auto storage) */
extern X_coupled_tanks_T coupled_tanks_X;
 ...
 *
 * '<Root>' : 'coupled_tanks'
 * '<S1>'   : 'coupled_tanks/InterTravamento'
 * '<S2>'   : 'coupled_tanks/PLANTA'
 * '<S3>'   : 'coupled_tanks/InterTravamento/Compare To Constant'
 * '<S4>'   : 'coupled_tanks/InterTravamento/Compare To Constant1'
 * '<S5>'   : 'coupled_tanks/InterTravamento/Compare To Constant2'
 * '<S6>'   : 'coupled_tanks/InterTravamento/Compare To Constant3'
 * '<S7>'   : 'coupled_tanks/InterTravamento/Compare To Zero'
 * '<S8>'   : 'coupled_tanks/InterTravamento/Compare To Zero1'
 */
