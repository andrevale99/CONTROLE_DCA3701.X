  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% coupled_tanks_P.Integrator_e_IC
	  section.data(6).logicalSrcIdx = 75;
	  section.data(6).dtTransOffset = 5;
	
	  ;% coupled_tanks_P.Integrator_m_IC
	  ...
	  ;% coupled_tanks_P.Kp_m_Gain
	  section.data(9).logicalSrcIdx = 78;
	  section.data(9).dtTransOffset = 8;
	
	  ;% coupled_tanks_P.Integrator_gain_IC
	  section.data(10).logicalSrcIdx = 79;
	  section.data(10).dtTransOffset = 9;
	
	  ;% coupled_tanks_P.N_mfiltergain_Gain
	  section.data(11).logicalSrcIdx = 80;
	  section.data(11).dtTransOffset = 10;
	
	  ;% coupled_tanks_P.kd_m_Gain
	  section.data(12).logicalSrcIdx = 81;
	  section.data(12).dtTransOffset = 11;
	
	  ;% coupled_tanks_P.Kp_e_Gain
	  section.data(13).logicalSrcIdx = 82;
	  section.data(13).dtTransOffset = 12;
	
	  ;% coupled_tanks_P.Integrator_gain2_IC
	  ...
	  ;% coupled_tanks_P.KawKptaw_Gain
	  section.data(21).logicalSrcIdx = 90;
	  section.data(21).dtTransOffset = 20;
	
	  ;% coupled_tanks_P.Ki_e_Gain
	  section.data(22).logicalSrcIdx = 91;
	  section.data(22).dtTransOffset = 21;
	
	  ;% coupled_tanks_P.Ki_m_Gain
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% coupled_tanks_B.Integrator_e
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% coupled_tanks_B.Integrator_m
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 3;
	  ...
	  ;% coupled_tanks_B.Kp_m
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 6;
	
	  ;% coupled_tanks_B.N_mfiltergain
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 7;
	  ...
	  ;% coupled_tanks_B.Kp_e
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 10;
	
	  ;% coupled_tanks_B.N_mfiltergain1
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 11;
	
	  ;% coupled_tanks_B.kd_e
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 12;
	  ...
	  ;% coupled_tanks_B.Ki_m
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 15;
	
	  ;% coupled_tanks_B.Sum3
	  section.data(17).logicalSrcIdx = 16;
	  section.data(17).dtTransOffset = 16;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% coupled_tanks_DW.TimeStampA_g
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 70;
	
	  ;% coupled_tanks_DW.LastUAtTimeA_p
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 71;
	
	  ;% coupled_tanks_DW.TimeStampB_o
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 72;
	
	  ;% coupled_tanks_DW.LastUAtTimeB_f
	  section.data(17).logicalSrcIdx = 16;
	  ...
	  ;% coupled_tanks_DW.AesdeControle_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 20;
	  section.data(3).dtTransOffset = 2;
	
	  ;% coupled_tanks_DW.AesdeControleMalhaEscrava_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 21;
	  section.data(4).dtTransOffset = 3;
	
	  ;% coupled_tanks_DW.AesdeControleMalhaMestre_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 22;
	  section.data(5).dtTransOffset = 4;
	
	  ;% coupled_tanks_DW.Nveis_PWORK.LoggedData
  ...
  targMap.checksum0 = 1651906964;
  targMap.checksum1 = 2341541868;
  targMap.checksum2 = 3275036923;
  targMap.checksum3 = 996918998;
