...
typedef struct {
  ...
  real_T u;                            /* '<Root>/Tensao de Entrada (-4<= Constante <= 4)' */
  real_T Integrator[2];                /* '<Root>/Integrator' */
  real_T Nv1_erro_estimado;            /* '<Root>/Sum3' */
  real_T Nv2_erro_estimado;            /* '<Root>/Sum2' */
  real_T B[2];                         /* '<Root>/B' */
...
struct P_coupled_tanks_T_ {
  ...
  real_T VoltstocmTank2_Gain;          /* Expression: 30/4.8
                                        ...
                                        */
  real_T TensaodeEntrada4Constante4_Valu;/* Expression: 2
                                          * Referenced by: '<Root>/Tensao de Entrada (-4<= Constante <= 4)'
                                          */
  real_T Integrator_IC[2];             /* Expression: [5 5]
 ...
 * '<S2>'   : 'coupled_tanks/Compare To Constant1'
 * '<S3>'   : 'coupled_tanks/PLANTA'
 */
