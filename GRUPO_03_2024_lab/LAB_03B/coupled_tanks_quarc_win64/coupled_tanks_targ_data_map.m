  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% coupled_tanks_P.TensaodeEntrada4Constante4_Valu
	  section.data(3).logicalSrcIdx = 74;
	  section.data(3).dtTransOffset = 2;
	
	  ;% coupled_tanks_P.Integrator_IC
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% coupled_tanks_B.Integrator
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 3;
	
	  ;% coupled_tanks_B.Nv1_erro_estimado
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 5;
	
	  ;% coupled_tanks_B.Nv2_erro_estimado
	  section.data(6).logicalSrcIdx = 5;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% coupled_tanks_DW.ErrosdeEstimativa_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 12;
	  section.data(3).dtTransOffset = 2;
	
	  ;% coupled_tanks_DW.EstadosEstimados_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 13;
	  section.data(4).dtTransOffset = 3;
	
	  ;% coupled_tanks_DW.Niveis_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 14;
	  section.data(5).dtTransOffset = 4;
	
	  ;% coupled_tanks_DW.Sinaldeentradau_PWORK.LoggedData
  ...
  targMap.checksum0 = 1606207663;
  targMap.checksum1 = 2967321075;
  targMap.checksum2 = 1177262041;
  targMap.checksum3 = 486387923;
