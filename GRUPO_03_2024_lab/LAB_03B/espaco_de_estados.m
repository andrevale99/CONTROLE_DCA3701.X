...
%colocar so dois polos
%Polos = [-0.1 ;-0.3] % Polos arbitrarios
%Polos = [-0.3 ;-0.5] % Polos arbitrarios
%Polos = [-0.7 ;-0.9]; % Polos arbitrarios
Polos = [-1. ; -1.2]; % Polos arbitrarios
