 ...
 * C source code generated on : Fri Oct 11 16:00:51 2024
 *
...
void coupled_tanks_output(void)
{
   ...
   */
  if (coupled_tanks_B.VoltstocmTank1 >= coupled_tanks_P.CompareToConstant_const)
  {
...
RT_MODEL_coupled_tanks_T *coupled_tanks(void)
{
  ...
  /* External mode info */
  coupled_tanks_M->Sizes.checksums[0] = (1163329874U);
  coupled_tanks_M->Sizes.checksums[1] = (1713076067U);
  coupled_tanks_M->Sizes.checksums[2] = (2405137755U);
  coupled_tanks_M->Sizes.checksums[3] = (3681833629U);
  ...
  coupled_tanks_M->Sizes.numBlocks = (11);/* Number of blocks */
